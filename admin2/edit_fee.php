...
<div class="flex justify-center items-center">
    ...
    <form method="post" enctype="multipart/form-data" action="edit_fee_id.php" class="flex justify-center">
		...
		<div class="flex w-fit">
                <tr>
                    <td class="w-fit px-4 py-2 text-white" style="background-color:orangered;">Edit User's Deposit Data</td> 
	</tr>
	    </div>
            ...
            <div class="flex w-fit">
                <tr>
                    <td class="w-fit border-b-2 border-black text-white">Username:</td>
            ...
            <div>
                <tr>
                    <td class="w-fit border-b-2 border-black text-white">Total Fee:</td>
                    <td class="border-b-2 border-black">
            ...
            <div>
                <tr>
                    <td class="w-fit border-b-2 border-black text-white">Latest Deposit Date:</td>
                    <td class="border-b-2 border-black">
            ...
            <div>
                <tr>
                    <td class="w-fit border-b-2 border-black text-white">End Date:</td>
                    <td class="border-b-2 border-black">
            ...
            <div>
                <tr>
                    <td class="w-fit border-b-2 border-black text-white">Date:</td>
                    <td class="border-b-2 border-black">
            ...
            <tr class="w-fit h-12">
                <td class=""><input type="submit" name="update" value="Update"
                        class="text-white px-6 py-2 mt-8" style="background-color:orangered; border-radius:13px;"></td>
            </tr>
            <?php
	}
}
