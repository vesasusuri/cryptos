...
if(isset($_GET['edit'])){
	...
	$edit_query = "SELECT * FROM withdraw WHERE id='$edit_id'";
...
<div class="flex justify-center items-center">
    ...
    <form method="post" enctype="multipart/form-data" action="edit_withdraw_id.php" class="flex justify-center">
        <table>
		<div class="flex w-fit">
            ...
            <div class="flex w-fit">
                <tr>
                    <td class="w-fit border-b-2 border-black text-white">Id:</td>
            ...
            <div>
                <tr>
                    <td class="w-fit border-b-2 border-black text-white">Bitcoin Wallet:</td>
                    <td class="border-b-2 border-black">
                        <input class="w-full h-8" type="text" name="bwallet" size="30"
                            value="<?php echo $erow['bwallet']; ?>">
                    </td>
                </tr>
            </div>
            ...
            <div>
                <tr>
                    <td class="w-fit border-b-2 border-black text-white">To Btc Address:</td>
                    <td class="border-b-2 border-black">
                        <input class="w-full h-8" type="text" name="btcAddress" size="30"
                            value="<?php echo $erow['btcAddress'];?>">
                    </td>
                </tr>
            </div>
            ...
            <div>
                <tr>
                    <td class="w-fit border-b-2 border-black text-white">Email:</td>
                    <td class="border-b-2 border-black">
                        <input class="w-full h-8" type="email" name="username" size="30" value="<?php echo $erow['username'];?>">
                    </td>
                </tr>
            </div>
            ...
            <div>
                <tr>
                    <td class="w-fit border-b-2 border-black text-white">Amount:</td>
                    <td class="border-b-2 border-black">
                        <input class="w-full h-8" type="username" name="amount" size="30" value="<?php echo $erow['amount'];?>">
                    </td>
                </tr>
            </div>
            ...
            <div>
                <tr>
                    <td class="w-fit border-b-2 border-black text-white">Status</td>
                    <td class="border-b-2 border-black">
                        <select name="status">
