...
<div id="searchbox" style="margin-left:400px">
	<br><br><br>
	<form action="searchUseres.php" method="get" enctype="multi/form-data" >
    ...
    <div class="relative">
        ...
        <input type="search" name="value"id="default-search" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Users" required>
