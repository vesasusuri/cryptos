                ...
                <div class="availableBalance">
                    ...
                    <div class="descBox">
                        ...
                        <span><?php
                            ...
                            <?php } ?>
                            <div class="flex">
                                <p class="text-2xl mr-1">$</p>
                                <input type="text" disabled name="usd"
                                    class="currencyField text-black bg-white w-full text-2xl" placeholder="USD"
                                    value="<?php echo $nullvlera;?>">
                                <p class="mr-2 mt-1.5">/</p>
                                <input type="number" name="btc" class="currencyField text-black bg-white text-sm"
                ...
                <div class="historyBox">
                    ...
                    <div class="descBox">
                        ...
                        <div class="descInformation">
                            <span>Deposit - <?php //echo $date ?> - BTC </span>
                            <span class="grColor">Recover $
                                <?php
                                    $con = mysqli_connect("localhost", "root", "", "crypto");
                                    mysqli_select_db($con, "crypto");
                                    ...
                                    $nullvlera1 = 0;
                                    while ($row = mysqli_fetch_array($run_produktet)) {
                                        $nullvlera1 += $row['amount'];
                                    ?>
                                <?php } ?>
                                <?php echo $nullvlera1; ?> </span>
                            <span class="puColor">
                                Total Fee
                                <?php
                                    $con = mysqli_connect("localhost", "root", "", "crypto");
